      ...
      "respuestas": [
        ...
        },
        {
		 ...
		 $.each(preguntas, function( i, item ) {
			...
			var div=' <div class="indepth_pregunta_item"><div class="indepth_pregunta">'+(i+1)+'- '+item.pregunta+'</div><div class="indepth_pregunta_main"><div class="indepth_pregunta_img"><img class="oculta" src="'+urlIndepth+'images/preguntas/'+(i+1)+'.jpg" /><img class="muestra" src="'+urlIndepth+'images/preguntas/bien/'+(i+1)+'.jpg" /></div><div class="indepth_respuestas_cont" num="'+i+'">';
