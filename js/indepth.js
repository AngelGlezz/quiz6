      ...
      "respuestas": [
        ...
        },
        {
		 ...
		 $.each(preguntas, function( i, item ) {
			...
			var div=' <div class="indepth_pregunta_item"><div class="indepth_pregunta">'+(i+1)+'- '+item.pregunta+'</div><div class="indepth_pregunta_main"><div class="indepth_pregunta_img"><img class="oculta" src="'+urlIndepth+'images/preguntas/'+(i+1)+'.png" /><img class="muestra" src="'+urlIndepth+'images/preguntas/bien/'+(i+1)+'.png" /></div><div class="indepth_respuestas_cont" num="'+i+'">';
        ...
        $(this).parent().parent().find(".oculta").hide("fast");
        $(this).parent().parent().find(".muestra").show("fast");
				...
				$(".indepth_pregunta_item").animate({"top": "-="+mov+"px"}, 1000);
		 });
...
function finish_test(){
	...
	$("#indepth_resultados").css({
  	...
  	if(aciertos<=5){
	  	aficionado="";
	  	msg="ya ni con Vucetich me dio tanta pena";
  	}
  	
  	if(aciertos>=6 &&aciertos<=10){
	  	aficionado="";
	  	msg="si yo fuera el Tuca, ya te habría corrido.";
  	}

  	if(aciertos>=11 && aciertos<=15){
	  	aficionado="";
	  	msg="¡Puedes mejorar eso! ¡Ya traes nivel para estar en la Selección!";
  	}

  	if(aciertos>=16){
	  	aficionado="";
	  	msg="hablan bien de ti ¡Llámale a Osorio! ¡No puede estar sin ti para la fase final de Copa América!";
  	}
